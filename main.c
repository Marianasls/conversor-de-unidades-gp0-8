...
void conversao_tempo()
{
    ...
    // Executando a conversão com base na escolha
    ...
    case 1: // Segundos para Minutos
        ...
        break;
    case 2: // Segundos para Horas
        resultado = valor / 3600;
        printf("O valor convertido é: %.2f horas\n", resultado);
        break;
    case 3: // Minutos para Segundos
        resultado = valor * 60;
        printf("O valor convertido é: %.2f segundos\n", resultado);
        break;
    case 4: // Minutos para Horas
        resultado = valor / 60;
        printf("O valor convertido é: %.2f horas\n", resultado);
        break;
    case 5: // Horas para Segundos
        resultado = valor * 3600;
        printf("O valor convertido é: %.2f segundos\n", resultado);
        break;
